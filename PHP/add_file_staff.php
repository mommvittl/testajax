...
$str = "";
if($result1) { $str .= 'Фото сотрудника добавлено.'; }
	else {  $str .= 'Фото сотрудника добавить не удалось.';   }
if($result2) { $str .= 'Резюме сотрудника добавлено.'; }
	else {  $str .= 'Резюме сотрудника добавить не удалось.';   }
echo $str;
